...
/**
  * Created by xiaoze on 2020-01-16-9:49
  */
...
object HotItems
{
  def main(args: Array[String]): Unit =
  {
    ...
    //val dataStream = env.readTextFile("D:\\ZxZ\\BigData\\AllProject\\UserBehaviorAnalysis\\HotItemsAnalysis\\src\\main\\resources\\UserBehavior.csv")
    ...
    val processStream: DataStream[String] = dataStream
      ...
      .aggregate(new CountAgg(), new WindowResult()) //窗口聚合，输出位自定义数据结构
...
class AverageAgg() extends AggregateFunction[UserBehavior,(Long,Int),Double]
{
  ...
  override def merge(a: (Long, Int), b: (Long, Int)): (Long, Int) = (a._1 + b._1,a._2 + a._2)
}
